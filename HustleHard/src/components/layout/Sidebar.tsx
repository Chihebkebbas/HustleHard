        ...
        <aside className={`${styles.sidebar} ${className}`.trim()}>
            ...
            <div className={styles.navGroup}>
                ...
                <nav className={styles.navMenu}>
                    <a href="dashboard.html" className={`${styles.navItem} ${styles.active}`}>
                    ...
                    <a href="tasks.html" className={styles.navItem}>
                        <svg className={styles.navItemIcon} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round"
                    ...
                    <a href="goals.html" className={styles.navItem}>
                        <svg className={styles.navItemIcon} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                        </svg>
                        Objectifs
                    </a>
                    <a href="habits.html" className={styles.navItem}>
                        <svg className={styles.navItemIcon} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round"
            ...
            <div className={styles.navGroup}>
                ...
                <nav className={styles.navMenu}>
                    <a href="programs.html" className={styles.navItem}>
                        <svg className={styles.navItemIcon} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round"
                    ...
                    <a href="analysis.html" className={styles.navItem}>
                        <svg className={styles.navItemIcon} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round"
                    ...
                    <a href="history.html" className={styles.navItem}>
                        <svg className={styles.navItemIcon} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round"
            ...
            <a href="profile.html" className={styles.sidebarProfile}>
